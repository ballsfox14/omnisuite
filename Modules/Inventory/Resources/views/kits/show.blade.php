        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- Información del kit y QR en dos columnas -->
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                        <!-- Columna izquierda: datos del kit (2/3 del ancho) -->
                        <div class="lg:col-span-2">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    <p class="text-sm font-medium text-gray-500 flex items-center gap-1">
                                        <span class="material-icons text-gray-400">calendar_today</span> Fecha de
                                        creación
                                    </p>
                        ...
                        <!-- Columna derecha: QR y acciones (1/3 del ancho) -->
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 text-center">
                            ...
                            <a href="data:image/svg+xml,{{ rawurlencode($kit->qr_code) }}"
                                ...
                                class="mt-3 inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-800 bg-white py-2 px-4 rounded border border-blue-300 hover:bg-blue-50 transition">
                    ...
                    <h4 class="text-md font-semibold mt-6 mb-2 flex items-center gap-2">
                    ...
                    @else
                        <p class="text-gray-500">Este kit no contiene herramientas.</p>
                    @endif
                </div>
            </div>
        </div>
